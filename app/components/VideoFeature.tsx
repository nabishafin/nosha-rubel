    ...
    <div className="overflow-hidden rounded-2xl border border-gray-200 bg-gray-950 shadow-sm">
      <div className="grid lg:grid-cols-[minmax(260px,360px)_1fr]">
        <div className="mx-auto w-full max-w-[360px] bg-black lg:mx-0">
          <div className="aspect-[9/16]">
            <iframe
              ...
              title="EIN VOLLKOMMEN VERWAHRLOSTER BAHNHOF POTSDAM-GRIEBNITZSEE"
              loading="lazy"
        ...
        <div className="flex flex-col justify-center p-6 text-white sm:p-8 lg:p-10">
          <p className="text-xs font-extrabold uppercase tracking-[0.2em] text-red-400">Video-Bericht · Potsdam</p>
